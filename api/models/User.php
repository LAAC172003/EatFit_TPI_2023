...
class User extends Model
{
    ...
    public static function getUserByToken($expiration = true): ?array
    {
        return parent::getUserByToken($expiration); // TODO: Change the autogenerated stub
    }
    ...
    public static function update(array $data): array|string
    {
        ...
        if ($token != null) return ["Updates" => $sb, "token" => $token];
        return $sb;
    }
